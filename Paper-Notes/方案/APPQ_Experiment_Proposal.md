...
置信度_真实 = 1.0 if 真实队列 > 阈值 else 0.3
置信度_幽灵 = 1.0 if 幽灵队列 > 阈值 else 0.3

权重_真实 = 置信度_真实 / (置信度_真实 + 置信度_幽灵)
权重_幽灵 = 置信度_幽灵 / (置信度_真实 + 置信度_幽灵)

最终ECN概率 = 权重_真实 × 真实队列ECN概率 + 权重_幽灵 × 幽灵队列ECN概率
```
